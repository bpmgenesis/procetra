...
export class KnownColors {
    ...
    public static argbByName: Dictionary<string, number[]> = undefined;
    public static nameByArgb: Dictionary<number[], string> = undefined;

    public static get ArgbByName(): Dictionary<string, number[]> {

        if (KnownColors.argbByName == null) {
            KnownColors.argbByName = new Dictionary<string, number[]>();
    ...
    public static get NameByArgb(): Dictionary<number[], string> {
        if (KnownColors.nameByArgb == null) {
            KnownColors.nameByArgb = new Dictionary<number[], string>();
