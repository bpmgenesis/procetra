...
export class DashboardSubMenuItemCollection extends List<DashboardMenuItem> {
    public DashboardSubMenuItem: DashboardMenuItem = null as any;
    public constructor(dashboardMenu: DashboardMenuItem) {
        super();
        this.DashboardSubMenuItem = dashboardMenu;
    }
