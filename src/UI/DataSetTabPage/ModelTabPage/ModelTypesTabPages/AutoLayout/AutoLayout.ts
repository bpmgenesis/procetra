...
export function AutoLayout() {
  this.moddle = new (BpmnModdle as any)();
...
AutoLayout.prototype.layoutProcess = function (xmlStr, callback) {
  ...
  return new Promise(function (resolve, reject) {
    moddle.fromXML(xmlStr).then(e => {
      console.log(e)
      // create new di section
      const moddleWithoutDi = e.rootElement;
      ...
      moddle.toXML(moddleWithoutDi).then(e=>{
        resolve(e);
      });
    });
  });
