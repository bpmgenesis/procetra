import {
  ...
  Registry.prototype.registerPackage = function(pkg) {
    ...
    // register types
    forEach(pkg.types, (bind as any)(function(descriptor) {
  ...
  Registry.prototype.registerType = function(type, pkg) {
    ...
    // parse properties
    forEach(type.properties, (bind as any)(function(p) {
    ...
    forEach(type.extends, (bind as any)(function(extendsName) {
