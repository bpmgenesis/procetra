...
export class ResourceOverviewGrid extends GridView {
    protected InitComponents(): void {
        const activityCol = new GridColumn('org:resource', 'Resource');
            ...
            getValue: (column: any, data: any): Object => {
                return `<span>
                            <table>
                                <tr>
                                    <td>
                                        <div style='text-align:right;width:40px;padding:2px;paddingright:5px;'>${data.rate}%</div>
                                    </td>
                                    <td>
