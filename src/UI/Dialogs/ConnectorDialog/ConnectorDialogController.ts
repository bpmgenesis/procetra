import { UIController, UIView, Text, TwoColumnLayout, ForEach, Icon, State, UIScene, UIImage, HStack, VStack, Alignment, Fonts, If } from '@tuval/forms';
            ...
            UIScene(
                TwoColumnLayout({
                    left: [
                        ...
                        ).width('200px').background('rgb(120,120,120,10%)').cornerRadius('12px 0px 0px 12px').grow(),
                    ],
                    right: [
                        VStack(
                            HStack(
