...
export class ImportEBAActivity extends ActivityBase implements IDataSourceActivity {

    public ConfigRequired: boolean = true;

    private Name: string = 'Import Csv';

    private eBAConnectorDialog:eBADatasetConnectorDialog;
    private csvSelectFile: FileUpload;
    private selected_file_name: string = 'eBA Dataset';
    private csv_string = '';
    private sep: string;
    ...
    public Config() {
        ...
        this.eBAConnectorDialog.ShowDialog();
    }
    public Init() {
        ...
        this.parent.Controls.Add(this.eBAConnectorDialog);

        this.eBAConnectorDialog.OkButtonClicked.add((_data: any) => {
            ...
            <div class="flex flex-column" ondblclick={() => this.Config()} draggable="true" ondragstart={(event) => this.drag(event)}>
                <div class="flex align-items-center justify-content-center h-4rem m-2">
                    <BlockUI blocked={this.loading} template={<img style='width:50px;height:50px;' src={Resources.Icons.Loading}></img>}>
                        <img style="width:64px;height:64px;" src="https://bpmgenesis.com/broker/symbol/GetSymbol/Integrations/Data%20Connectors/eba"></img>
                    </BlockUI>
                </div>
