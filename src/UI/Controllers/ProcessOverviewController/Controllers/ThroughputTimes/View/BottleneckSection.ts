import { UIView, VStack, HStack, Spacer, UIButton, Icon, Alignment, RoundedRectangle, UIImage, ForEach, cTopLeading } from '@tuval/forms';
import { SectionHeadline, SectionSubHeadline, RegularText } from '../../../../../Views/Texts';
                    ...
                    HStack(
                        ...
                        VStack({ alignment: cTopLeading })(
                            HStack(
                                ...
                                RegularText('Change Price').fontSize('16px').fontWeight('500').foregroundColor('#1d6c83')
                            ).spacing(5).width().height().padding('10px 15px 10px 15px')
                        )
                    )
                        .padding(10)
                        .shadow({ hover: '0 2px 10px rgb(0 0 0 / 16%), 0 2px 5px rgb(0 0 0 / 26%)' })
                        .height(122)
